                ...
                <div className="row">
                    {Array.isArray(listBarang) &&
                        listBarang.map((element, index) => {
                            return (
                                <div
                                    className="container col-md-12 animated zoomIn"
                                    id="containerCard"
                                    key={index}
                                >
                                    <div
                            ...
                            >
                                <div className="md-form mt-3">
                                    <input
                                        ...
                                        defaultValue={this.state.namaBarang}
                                        placeholder="nama barang"
                                    />
                                </div>
                                <div className="md-form">
                                    <input
                                        ...
                                        className="form-control"
                                        onChange={this.handleChange}
                                        defaultValue={this.state.jumlahBarang}
                                ...
                                <div className="md-form">
                                    <input
                                        ...
                                        className="form-control"
                                        onChange={this.handleChange}
                                        defaultValue={this.state.urlBarang}
                                        placeholder="url barang"
                                    />
                                </div>
                                <button
                                    className="btn btn-dark btn-rounded btn-block z-depth-0 my-4 waves-effect"
                                    type="submit"
                                >
                                    Edit Barang
                                </button>
